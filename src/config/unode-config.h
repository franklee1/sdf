/* src/config/unode-config.h.  Generated from unode-config.h.in by configure.  */
/* src/config/unode-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef unode_CONFIG_H

#define unode_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/unodepay/unode/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "unode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "unode Core 1.2.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "unodecore"
